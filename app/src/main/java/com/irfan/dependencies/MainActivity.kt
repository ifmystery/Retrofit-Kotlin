package com.irfan.dependencies

import UsersAdapter
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import android.widget.Toast
import com.irfan.dependencies.data.ResultUsers
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        NetworkConfig().getService().getUsers().enqueue(object : Callback<List<ResultUsers>> {
            ...
            override fun onResponse(call: Call<List<ResultUsers>>,response: Response<List<ResultUsers>>) {
